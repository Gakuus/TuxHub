...
<head>
    ...
    <title>Acceso denegado — Agora</title>
    ...
    <style>
        ...
        .error-code { font-size: 6rem; font-weight: 800; background: linear-gradient(135deg, #f87171, #ef4444); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
    ...
    <div class="login-wrapper">
        <main class="login-main">
            <div class="login-card error-container">
                ...
                <p class="error-text">No tienes permisos para acceder a esta página.</p>
                <a href="index.php" class="btn-back"><i class="bi bi-box-arrow-in-right"></i> Volver al inicio</a>
