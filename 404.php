...
<head>
    ...
    <title>Página no encontrada — Agora</title>
    ...
    <style>
        ...
        .error-code { font-size: 6rem; font-weight: 800; background: linear-gradient(135deg, #fbbf24, #f59e0b); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
    ...
    <div class="login-wrapper">
        <main class="login-main">
            <div class="login-card error-container">
                ...
                <p class="error-text">La página que buscas no existe o fue movida.</p>
                <a href="dashboard.php" class="btn-back"><i class="bi bi-grid-fill"></i> Ir al dashboard</a>
